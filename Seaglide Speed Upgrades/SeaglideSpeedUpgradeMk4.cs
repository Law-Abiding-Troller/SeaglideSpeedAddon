...
namespace SeaglideSpeedAddon
{
    public class SeaglideSpeedModulePrefab
    {
        ...
        public static void Register()
        {
            ...
            Plugin.prefabinfo[Plugin.index] = PrefabInfo.WithTechType($"SeaglideSpeedUpgradeMk{Plugin.changespeedmultiplier}", $"Seaglide Speed Upgrade Module Mk {Plugin.changespeedmultiplier}", $"Mk {Plugin.changespeedmultiplier} Speed Upgrade Module for the Seaglide. {Plugin.speedmultiplier[Plugin.index]}x normal speed.")
        ...
        {
            if (Plugin.changespeedmultiplier == 4)
            {
                return SeaglideSpeedModuleMk3.Info.TechType;
            }
            else
            {
